...
public class BrowserExample
{
    ...
    {
            "eclipse01.bmp", "eclipse02.bmp", "eclipse03.bmp", "eclipse04.bmp", "eclipse05.bmp", "eclipse06.bmp",
            "eclipse07.bmp", "eclipse08.bmp", "eclipse09.bmp", "eclipse10.bmp", "eclipse11.bmp", "eclipse12.bmp",
    };
    ...
    public BrowserExample(Composite parent, boolean top)
    {
        ...
        catch (SWTError e)
        {
            ...
            label
                .setText("Error - The Browser widget could not be instantiated. Please check the Browser widget is supported on this platform. Supported platforms and software requirements for the Browser widget are listed on the SWT FAQ web page.");
            parent.layout(true);
            return;
        }
        initResources();
              ...
              boolean toolBar)
    {
        ...
        if (toolBar)
        {
            ...
            itemBack.setImage(Activator.getImage(false, "icons" + File.separator + "nav_backward.gif"));

            itemForward = new ToolItem(toolbar, SWT.PUSH);
            itemForward.setImage(Activator.getImage(false, "icons" + File.separator + "nav_forward.gif"));

            final ToolItem itemStop = new ToolItem(toolbar, SWT.PUSH);
            itemStop.setImage(Activator.getImage(false, "icons" + File.separator + "stop.gif"));

            final ToolItem itemRefresh = new ToolItem(toolbar, SWT.PUSH);
            itemRefresh.setImage(Activator.getImage(false, "icons" + File.separator + "refresh.gif"));

            final ToolItem itemGo = new ToolItem(toolbar, SWT.PUSH);
            itemGo.setImage(Activator.getImage(false, "icons" + File.separator + "run.gif"));
        ...
        if (title)
        {
            browser.addTitleListener(new TitleListener()
            {
                ...
                {
                    shell.setText(event.title + " - SWT Browser");
                }
            });
        }
        parent.layout(true);
